...
export class KpiCardComponent {
  ...
  readonly themeStyles = computed(() => {
    const themes: Record<string, {
      ...
      iconBg: string; iconHover: string; iconText: string;
      labelText: string; valueText: string; contextText: string;
    }> = {
      slate: {
        containerBg: 'bg-white', containerBorder: 'border-slate-100',
        iconBg: 'bg-slate-50', iconHover: 'group-hover:bg-slate-100', iconText: 'text-slate-700',
        labelText: 'text-slate-500', valueText: 'text-slate-900', contextText: 'text-slate-400',
      },
      indigo: {
        containerBg: 'bg-indigo-50/50', containerBorder: 'border-indigo-100',
        iconBg: 'bg-indigo-100', iconHover: 'group-hover:bg-indigo-200', iconText: 'text-indigo-600',
        labelText: 'text-indigo-600', valueText: 'text-indigo-900', contextText: 'text-indigo-400',
      },
      violet: {
        containerBg: 'bg-violet-50/50', containerBorder: 'border-violet-100',
        iconBg: 'bg-violet-100', iconHover: 'group-hover:bg-violet-200', iconText: 'text-violet-600',
        labelText: 'text-violet-600', valueText: 'text-violet-900', contextText: 'text-violet-400',
      },
      emerald: {
        containerBg: 'bg-emerald-50/50', containerBorder: 'border-emerald-100',
        iconBg: 'bg-emerald-100', iconHover: 'group-hover:bg-emerald-200', iconText: 'text-emerald-600',
        labelText: 'text-emerald-600', valueText: 'text-emerald-900', contextText: 'text-emerald-400',
      },
      amber: {
        containerBg: 'bg-amber-50/50', containerBorder: 'border-amber-100',
        iconBg: 'bg-amber-100', iconHover: 'group-hover:bg-amber-200', iconText: 'text-amber-600',
        labelText: 'text-amber-600', valueText: 'text-amber-900', contextText: 'text-amber-400',
      },
    };
  ...
  readonly infoIconTheme = computed(() => {
    const themesMap: Record<string, { bg: string; text: string; hover: string }> = {
      ...
      emerald: { bg: 'bg-emerald-50/50', text: 'text-emerald-300', hover: 'hover:text-emerald-600' },
